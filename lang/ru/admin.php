...
/**
 * Strings for component 'admin', language 'ru', version '4.3'.
 *
 * @package     admin
 * @category    string
...
$string['enablecommunicationsubsystem_desc'] = 'Разрешить интеграцию с поставщиками услуг связи, такими как Matrix, чтобы учителям и студентам было легче общаться. Управлять этими интеграциями можно в разделе <a href="settings.php?section=managecommunicationproviders">Плагины</a>.';
...
$string['hookdeprecates'] = 'Устаревшие обратные вызовы lib.php';
